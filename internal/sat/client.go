        ...
        httpClient: &http.Client{
            ...
            Transport: &http.Transport{
                TLSClientConfig: &tls.Config{
                    InsecureSkipVerify: false, // En producción siempre verificar
                },
            },
        },
    }
...
func (c *Client) DownloadCFDIS(ctx context.Context, rfc, password, period string) ([]*models.CFDI, error) {
    // Construir SOAP request para el SAT
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    ...
    // Parsear respuesta y extraer CFDI (simplificado)
    // En implementación real, se parsea el XML de respuesta del SAT
    // Aquí creamos un CFDI de ejemplo para demostración
    cfdis := []*models.CFDI{
        {
            Version: "4.0",
            Serie:   "A",
